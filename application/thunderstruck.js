...
function findWasmBinary() {
  return locateFile("application/thunderstruck.wasm");
}
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = thunderstruck_entry;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = thunderstruck_entry;
} else if (typeof define === 'function' && define['amd'])
  define([], () => thunderstruck_entry);
var isPthread = globalThis.self?.name?.startsWith('em-pthread');
var isNode = typeof globalThis.process?.versions?.node == 'string';
if (isNode) isPthread = require('worker_threads').workerData === 'em-pthread'

// When running as a pthread, construct a new instance on startup
isPthread && thunderstruck_entry();
